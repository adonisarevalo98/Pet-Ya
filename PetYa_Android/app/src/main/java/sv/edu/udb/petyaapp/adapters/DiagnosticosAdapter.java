...
public class DiagnosticosAdapter extends ArrayAdapter<Diagnosticos> {
    ArrayList<Diagnosticos> diagnosticoList;
    Context context;
    int resource;
    public DiagnosticosAdapter(Context context, int resource, ArrayList<Diagnosticos> diagnosticoList) {
       ...
       // textView2.setText(concat3);
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, Detalles_Diagnostico.class);
                ...
                intent.putExtra("tratamiento",diagnosticoList.getCreated_at());
