...
public class actualizar_perfil_sec extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    //Variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actualizar_perfil_sec);
...
//Configurar las gso para google signIn con el fin de luego desloguear de google
        ...
        navigationView.setCheckedItem(R.id.editcuentasecretaria);  //item seleccionado por defecto
        /*******End Menu********/
        /*******scroll view********/
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()){
                ...
                case R.id.cita:
                    Intent intent = new Intent(actualizar_perfil_sec.this,Citas_secretaria.class);
    ...
    @Override protected void onStart() {
        ...
        if(user==null){
            ...
            Intent perfilusuario = new Intent(actualizar_perfil_sec.this, Login.class);
        ...
        mGoogleSignInClient.signOut().addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful()){
                    Intent intent = new Intent(actualizar_perfil_sec.this,Login.class);
                    startActivity(intent);
                    Toast.makeText(getApplicationContext(), "Hasta Luego!", Toast.LENGTH_LONG).show();
                    actualizar_perfil_sec.this.finish();
