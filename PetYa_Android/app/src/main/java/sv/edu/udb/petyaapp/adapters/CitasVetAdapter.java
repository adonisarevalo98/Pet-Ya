...
public class CitasVetAdapter extends ArrayAdapter<CitasVeterinario> {
    ArrayList<CitasVeterinario> citaList;
    Context context;
    int resource;
    public CitasVetAdapter(Context context, int resource, ArrayList<CitasVeterinario> citaList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        CitasVeterinario citaList=getItem(position);
        ...
        concat5= "Encargado: " + citaList.getCliente_id();
